...
class AutoModel {
    ...
    listar() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const usuarios = yield this.db.query('SELECT * FROM auto');
    ...
    buscarNombre(nombre) {
        return __awaiter(this, void 0, void 0, function* () {
            const encontrado = yield this.db.query('SELECT * FROM auto WHERE patente = ?', [nombre]);
            //Ojo la consulta devuelve una tabla de una fila. (Array de array) Hay que desempaquetar y obtener la unica fila al enviar
            if (encontrado.length > 1)
                return encontrado[0][0];
            return null;
    ...
    crear(usuario) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = (yield this.db.query('INSERT INTO auto SET ?', [usuario]))[0].affectedRows;
            console.log(result);
            return result;
        });
    }
...
exports.default = autoModel;
//# sourceMappingURL=autoModel%20-%20copia.js.map