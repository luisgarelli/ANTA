...
class AutosRoutes {
    ...
    config() {
        ...
        //CRUD
        this.router.post('/agregar', verifyToken_1.TokenValidation, autoController_1.default.agregaAuto);
        this.router.get('/listar', verifyToken_1.TokenValidation, autoController_1.default.listaAuto);
        this.router.get('/buscar/:id', verifyToken_1.TokenValidation, autoController_1.default.buscarAuto);
        this.router.put('/modificar/:id', verifyToken_1.TokenValidation, autoController_1.default.actualizar);
        this.router.delete('/eliminar/:id', verifyToken_1.TokenValidation, autoController_1.default.eliminar);
    }
}
...
//# sourceMappingURL=autosRoutes.js.map